...
export const composeDecoratorMiddlewares = (
  ...middlewares: DecoratorMiddleware[]
): DecoratorMiddleware => (decoratedHandler: DecoratedHandler) => {
  const decoratorChain = middlewares.reduceRight(
...
export const composeDecoratedHandler = (
  handler: DecoratedHandler,
  ...middlewares: DecoratorMiddleware[]
): Handler => composeDecoratorMiddlewares(...middlewares)(handler);
